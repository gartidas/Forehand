...
namespace WebApi.Migrations
{
    ...
    [Migration("20220308185026_RatingAsJoinTableProp")]
    partial class RatingAsJoinTableProp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Domain.CustomerRating", b =>
                {
                    b.Property<string>("RatedById")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("RatedTrainerId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("Rating")
                        .HasColumnType("int");

                    b.HasKey("RatedById", "RatedTrainerId");

                    b.HasIndex("RatedTrainerId");
            ...
            modelBuilder.Entity("WebApi.Domain.CustomerRating", b =>
                {
                    b.HasOne("WebApi.Domain.Customer", "RatedBy")
                        .WithMany("RatedTrainers")
                        .HasForeignKey("RatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApi.Domain.Trainer", "RatedTrainer")
                        .WithMany("RatedBy")
                        .HasForeignKey("RatedTrainerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("RatedBy");

                    b.Navigation("RatedTrainer");
                });
